          ...
          <section class="wrapper site-min-height">
                ...
                <div class="col-sm-10 col-sm-offset-1 white-bg">
                    <?php 
                        ...
                        echo form_open('Transaksiadmin1/tahap1', $attributes); 
                    ?>
                    <!--kolom kiri-->
  ...
  <script type="text/javascript">
        $(document).ready(function(){
         ...
         $("#search_cust").keyup(function(){
            ...
            */
            ...
            $.ajax({
                url:"<?php echo base_url().index_page();?>/Transaksiadmin1/search_cust",
                type:"POST",
                data: keyword,
        ...
        $("#btn-pilih").click(function(){
            if($("#ls_cust").val() != null){
                ...
                $.ajax({
                    url:"<?php echo base_url().index_page();?>/Transaksiadmin1/get_cust",
                    type:"POST",
                    data: keyword,
                    success:function(msg){
                        $arr = msg;
        ...
        var load_tanah = function(){
            ...
            if($("#cb_blok").val() != null){
                ...
                $.ajax({
                    url:"<?php echo base_url().index_page();?>/Transaksiadmin1/get_tanah",
                    type:"POST",
                    data: keyword,
                    success:function(msg){
                        $arr = msg;
