        ...
        <section class="wrapper site-min-height">
            ...
            <div class="<?=$show_insert;?>">
                <div class="header-div-plain col-sm-8 col-sm-offset-2 mt" id="div-header">
                    <span class="fa fa-file"></span><span>TRANSAKSI PEMBELIAN</span>
                </div>
                <div class="col-sm-8 col-sm-offset-2 white-bg mb">
                    ...
                    <div class="form-group">
                        <label class="control-label col-sm-4" for="tnama">Tanggal Pembelian:</label>
                        <div class="col-sm-6">
                            <?php echo form_input(array('name'=>'tnama', 'id'=>'tnama', 'class'=>'form-control', 'placeholder'=>'Masukkan Tanggal Pembelian'), $tnama);?>
                            <?php echo form_error('tnama'); ?>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-sm-4" for="tnama">Jenis Pembelian:</label>
                        <div class="col-sm-6">
                    ...
                    <div class="form-group">
                        <label class="control-label col-sm-4" for="tnama">Pakan:</label>
                        <div class="col-sm-6">
                            <select class="form-control">
                                <option>Vit A</option>
                            </select>
                    ...
                    <div class="form-group">
                        <label class="control-label col-sm-4" for="tnama">Jumlah Item:</label>
                        <div class="col-sm-6">
                            <?php echo form_input(array('name'=>'tnama', 'id'=>'tnama', 'class'=>'form-control', 'placeholder'=>'Masukkan Jumlah Item'), $tnama);?>
                            <?php echo form_error('tnama'); ?>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-sm-4" for="tnama">Harga per Item</label>
                        <div class="col-sm-6">
                            <?php echo form_input(array('name'=>'tnama', 'id'=>'tnama', 'class'=>'form-control', 'placeholder'=>'Masukkan Harga peritem'), $tnama);?>
                            <?php echo form_error('tnama'); ?>
                        </div>
                    </div>
                    <div class="form-group">
