      ...
      <section id="main-content">
        <section class="wrapper site-min-height">
            <div class="header-div-plain col-sm-8 col-sm-offset-2 mt" id="div-header">
                <span class="fa fa-key"></span><span>UBAH TIMEOUT</span>
            </div>
            ...
            <div class="col-sm-8 col-sm-offset-2 white-bg row ">
                ...
                <div class="form-group">
                    <label class="control-label col-sm-4 col-sm-offset-1">Timeout Session (detik):</label>
                    <div class="col-sm-4">
                        <?php echo form_input(array('name'=>'time', 'id'=>'time', 'class'=>'form-control', 'placeholder'=>'Masukkan Timeout'), $time);?> 
                ...
                <div class="form-group">
                    <div class="col-sm-12">
                      <button type="submit" class="btn btn-success center-block btn-custom" id="submit" name="submit">Ubah Timeout</button>
                    </div>
                </div>
                <div class="form-group">
