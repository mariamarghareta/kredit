...
<html lang="en">
  <head>
    ...
    <title>Master Pengeluaran</title>
      ...
      <section id="main-content">
          <section class="wrapper site-min-height">
                <div class="header-div-plain header-div-green col-sm-10 col-sm-offset-1 mt" id="div-header">
                    <span class="fa fa-money"></span><span>TRANSAKSI PENGELUARAN</span>
                </div>
                <div class="col-sm-10 col-sm-offset-1 white-bg mb">
                    <?php 
                        $attributes = array('class' => 'form-horizontal', 'id' => 'form_pengeluaran');
                        echo form_open('Masterpengeluaran/add_new_data', $attributes); 
                    ?>
                    <!--kolom kiri-->
                    <div class="col-sm-12 mt">
                        ...
                        <div class="form-group">
                            <label class="control-label col-sm-4" >Jumlah Pengeluaran:</label>
                            <div class="col-sm-3">
                              <?php echo form_input(array('name'=>'uang', 'id'=>'uang', 'class'=>'form-control', 'placeholder'=>'Besar pengeluaran'), $uang);?>
                              <?php echo form_error('uang'); ?>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-sm-4">Tanggal Pengeluaran:</label>
                            <div class="col-sm-8">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                              <?php echo form_textarea(array('name'=>'ket', 'id'=>'ket', 'style'=>'height:120px;', 'class'=>'form-control', 'placeholder'=>'Keterangan pengeluaran'), $ket);?>
                    ...
                    <?php
                        ...
                        if($show_update == ""){
                    ?>
                    <input type="hidden" name="kd_pengeluaran" value="<?=$kd_pengeluaran?>" >
                    <div class="form-group"> 
  ...
  <script type="text/javascript">
     $(document).ready(function(){
        ...
        $("#ubah").click( function(){
            $("#form_pengeluaran").attr("action", "<?php echo base_url();echo index_page(); ?>/Masterpengeluaran/update_data");
            $("#form_pengeluaran").submit();
        });
         
        $("#batal").click( function(){
            $("#form_pengeluaran").attr("action", "<?php echo base_url();echo index_page(); ?>/Masterpengeluaran");
            $("#form_pengeluaran").submit();
        });
