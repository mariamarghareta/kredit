            ...
            <div class="col-sm-12 row mt-big">
                <div class="col-sm-10 col-sm-offset-1">
                 <?php 
                    ...
                    echo form_open('Transaksiadmin2/cek_nota', $attributes); 
                ?>
                ...
                <div class="col-sm-11 col-sm-offset-1 form-horizontal white-bg" id="div-header-info"> 
                    ...
                    <div class="form-group">
                        ...
                        <?php
                            if($data_ppjb == null){
                        ?>
                            <div class="control-label col-sm-3 col-xs-3 text-left"><?="Rp ". number_format(0 ,0,',','.') ?></div>
                        <?php
                            }else{
                        ?>
                            <div class="control-label col-sm-3 col-xs-3 text-left"><?="Rp ". number_format($data_ppjb->bayar ,0,',','.') ?></div>
                        <?php
                            }
                        ?>
                        <div class="col-sm-3 col-xs-3">
                    ...
                    <div class="col-sm-11 col-sm-offset-1 form-horizontal white-bg" id="div-cicilan-info"> 
                        ...
                        <?php
                                ...
                                foreach($detail_cash as $row){
                                    ...
                                    echo form_open('Mid/print_nota_again', $attributes); 
                                    echo "
                                    <div class='col-sm-12 col-xs-12 text-center mb'>
            ...
            <div class="row mt col-sm-6">
                ...
                <?php 
                    ...
                    if($show_cash_bayar == ""){
                        ...
                        echo form_open('Transaksiadmin2/bayar', $attributes); 
                ?>
                ...
                <div class="col-sm-11 col-sm-offset-1  form-horizontal white-bg mb"> 
                    ...
                    <div class="row" >
                        <?php
                            ...
                            echo form_open('Transaksiadmin2/urus_cash', $attributes); 
                        ?>
                        <input type="hidden" name="kd_trans" value="<?=$kd_trans?>"/>
                        <input type="hidden" name="nama" value="<?=$header->nama?>"/>
                        <input type="hidden" name="tipe_bayar" value="<?=$header->tipe_bayar?>"/>
                    ...
                    <div class="row">
                        <?php
                            ...
                            echo form_open('Transaksiadmin2/urus_dp', $attributes); 
                        ?>
                        <input type="hidden" name="kd_trans" value="<?=$kd_trans?>"/>
                        <input type="hidden" name="nama" value="<?=$header->nama?>"/>
                        <input type="hidden" name="tipe_bayar" value="<?=$header->tipe_bayar?>"/>
                ...
                <?php 
                    if($show_ppjb == ""){
                        ...
                        echo form_open('Transaksiadmin2/bayar_ppjb', $attributes); 
                ?>
                    <input type="hidden" name="kd_trans" value="<?=$kd_trans?>"/>
                    <input type="hidden" name="nama" value="<?=$header->nama?>"/>
                    <input type="hidden" name="tipe_bayar" value="<?=$header->tipe_bayar?>"/>
                    ...
                    <div class="col-sm-11 col-sm-offset-1 form-horizontal white-bg"> 
                        <div class="form-group">
                            ...
                            <div class="col-sm-6 ">
                                <?php echo form_input(array('name'=>'ppjb', 'id'=>'ppjb', 'class'=>'form-control', 'placeholder'=>'Biaya balik nama'), $ppjb);?>
