      ...
      <section id="main-content">
          <section class="wrapper site-min-height">
          	<div class="header-div-plain col-sm-8 col-sm-offset-2 mt" id="div-header">
                <span class="fa fa-search"></span><span>CARI DATA BONUS AGEN/SALES</span>
            </div>
            <div class="col-sm-8 col-sm-offset-2 white-bg row ">
                <?php 
                    $attributes = array('class' => 'form-horizontal', 'id' => 'form_tanah');
                    echo form_open('Laporanbonus/search', $attributes); 
                ?>
                <div class="col-sm-12">
            ...
            <div class="header-div-plain col-sm-12 mt" id="div-header">
                <span class="fa fa-table"></span><span>DATA BONUS AGEN/SALES</span>
            </div>
                                    ...
                                    if(sizeof($detail) > 0){
                                        foreach ($detail as $row)
                                        {
                                            ...
                                            foreach($row[1] as $subrow){
                                                echo "Kavling: " . $subrow['nama_blok'] . " " . $subrow['nomor_tanah']. "</br>Tgl Bayar PPJB: " . $subrow['tgl_bayar'] . "</br>Bonus: Rp " . number_format($subrow['bonus_agen'],0,",",".");
  ...
  <script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        $("#print").click( function(){
            ...
            $("#form_tanah").attr("action", "<?php echo base_url();echo index_page(); ?>/Laporanbonus/print_laporan");
            $("#form_tanah").submit();
            $("#form_tanah").prop("target", "_self");
            $("#form_tanah").attr("action", "<?php echo base_url();echo index_page(); ?>/Laporanbonus/search");
            //alert("aaa");
        });
    });
