        ...
        <section class="wrapper site-min-height">
            ...
            <div class="<?=$show_insert;?>">
                <div class="header-div-plain col-sm-8 col-sm-offset-2 mt" id="div-header">
                    <span class="fa fa-file"></span><span>MASTER JENIS PEMASUKAN</span>
                </div>
                <div class="col-sm-8 col-sm-offset-2 white-bg mb">
                    <?php
                    $attributes = array('class' => 'form-horizontal', 'id' => 'form_blok');
                    echo form_open('Masterjenispemasukan/add_new_data', $attributes);
                    ?>
                    <div class="form-group">
                        <label class="control-label col-sm-4" for="tnama">Jenis Pemasukan:</label>
                        <div class="col-sm-6">
                            <?php echo form_input(array('name'=>'name', 'id'=>'name', 'class'=>'form-control', 'placeholder'=>'Masukkan jenis pemasukan'), $name);?>
            ...
            <div class="<?=$show_update;?>" style="display:none;">
                <div class="header-div-plain col-sm-10 col-sm-offset-1 mt" id="div-header">
                    <span class="fa fa-pencil"></span><span>EDIT JENIS PEMASUKAN</span>
                </div>
                <div class="col-sm-10 col-sm-offset-1 white-bg">
                    <?php
                    $attributes = array('class' => 'form-horizontal', 'id' => 'update_karyawan');
                    echo form_open('Masterjenispemasukan/update_data', $attributes);
                    ?>
                    <div class="form-group mb">
                        <label class="control-label col-sm-4" for="nama">Jenis Pemasukan:</label>
                        <div class="col-sm-6">
            ...
            <div class="<?= $show_delete;?>" style="display:none;">
                <div class="header-div-plain col-sm-10 col-sm-offset-1 mt" id="div-header">
                    <span class="fa fa-times"></span><span>HAPUS JENIS PEMASUKAN</span>
                </div>
                <div class="col-sm-10 col-sm-offset-1 white-bg">
                    <div class="col-sm-10 col-sm-offset-1">
                        <?php
                        $attributes = array('class' => 'form-horizontal', 'id' => 'update_karyawan');
                        echo form_open('Masterjenispemasukan/confirm_del', $attributes);
                        ?>
            ...
            <div class="header-div-plain col-sm-12 mt" id="div-header">
                <span class="fa fa-table"></span><span>DATA JENIS PEMASUKAN</span>
            </div>
                ...
                <div class="col-sm-12 pl pr">
                    <div class="table-responsive">
                        <table id="tbkaryawan" class="table table-striped table-bordered" cellspacing="0" width="100%">
                            ...
                            <tbody>
                            <?php
                            foreach ($jenispemasukan as $row)
                            {
                                echo"<tr>";
                                echo "<td>" . $row->name ."</td>";
                                echo "<td>";
                                echo form_open('Masterjenispemasukan/edit_data');
                                ...
                                echo form_close();
                                echo "</td>";
                                echo form_open('Masterjenispemasukan/delete_data');
                                echo "<input type='hidden' name='id' id='id' value=$row->id></input>";
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        $("#menu_jenis_pemasukan").addClass('active');
