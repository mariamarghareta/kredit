    ...
    <section id="main-content">
        <section class="wrapper site-min-height">
            <div class="header-div-plain col-sm-8 col-sm-offset-2 mt" id="div-header">
                <span class="fa fa-search"></span><span>CARI DATA CICILAN NUNGGAK</span>
            </div>
            <div class="col-sm-8 col-sm-offset-2 white-bg row ">
                <?php
                $attributes = array('class' => 'form-horizontal', 'id' => 'form_dpnunggak');
                echo form_open('Laporancicilannunggak/search', $attributes);
                ?>
                <div class="col-sm-12">
            ...
            <div class="header-div-plain col-sm-12 mt" id="div-header">
                <span class="fa fa-table"></span><span>DATA CICILAN MENUNGGAK</span>
            </div>
                        ...
                        <table id="tab" class="table table-striped table-bordered" cellspacing="0" width="100%">
                            ...
                            if(sizeof($detail) > 0){
                                foreach ($detail as $row)
                                {
                                    ...
                                    echo "<input type=hidden name='kd_trans' id='kd_trans' value='".$row[0]['kd_trans']."' >";
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        $("#menu_cicilannunggak").addClass('active');
        ...
        $("#print").click( function(){
            ...
            $("#form_dpnunggak").attr("action", "<?php echo base_url();echo index_page(); ?>/Laporancicilannunggak/print_laporan");
            $("#form_dpnunggak").submit();
            $("#form_dpnunggak").prop("target", "_self");
            $("#form_dpnunggak").attr("action", "<?php echo base_url();echo index_page(); ?>/Laporancicilannunggak/search");
            //alert("aaa");
        });
    });
