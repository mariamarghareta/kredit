      ...
      <section id="main-content">
          <section class="wrapper site-min-height">
            ...
            <div class="col-sm-8 col-sm-offset-2 form-horizontal white-bg"> 
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-5 ">
                        <div class="date" data-date="" data-date-format="dd-mm-yyyy" data-link-field="dtp_input2" data-link-format="dd-mm-yyyy">
                            <input class="form-control datepicker"  data-date-format="dd-mm-yyyy" type="text" name="tgl_trans" style="width:150px" placeholder="dd-mm-yyyy" autocomplete="off" value="<?=$nota->tgl_trans?>" >
                ...
                <div class="form-group">
                    <?php
                        if(substr($kd_nota,0,1) == "C"){
                            $temp = "Cash";
                        }else if(substr($kd_nota,0,1) == "D"){
                            $temp = "DP/UM";
                        }else if(substr($kd_nota,0,1) == "I"){
                            $temp = "Cicilan";
                        }
                    ?>
                    <label class="control-label col-sm-6 col-xs-6" >Bayar <?=$temp?> :</label>
                    <div class="col-sm-5 ">
                        <?php echo form_input(array('name'=>'bayar', 'id'=>'bayar', 'class'=>'form-control', 'placeholder'=>'Biaya yang dibayarkan'), $nota->bayar);?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-5 ">
                        <div class="date" data-date="" data-date-format="dd-mm-yyyy" data-link-field="dtp_input2" data-link-format="dd-mm-yyyy">
                            <input class="form-control datepicker"  data-date-format="dd-mm-yyyy" type="text" name="jatuh_tempo" style="width:150px" placeholder="dd-mm-yyyy" autocomplete="off" value="<?=$nota->jatuh_tempo?>" >
                            <?php echo form_error('jatuh_tempo'); ?>
                        </div>
                    </div>
                    
                </div>
                <?php if(substr($kd_nota,0,1) == "I"){?>
                <div class="form-group">
                    <label class="control-label col-sm-6 col-xs-6" >Denda :</label>
                    <div class="col-sm-5 ">
                        <?php echo form_input(array('name'=>'denda', 'id'=>'denda', 'class'=>'form-control', 'placeholder'=>'Denda dibayarkan'), $nota->denda);?>
