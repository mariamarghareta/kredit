        ...
        <section class="wrapper site-min-height">
            ...
            <div class="<?=$show_insert;?>">
                <div class="header-div-plain col-sm-8 col-sm-offset-2 mt" id="div-header">
                    <span class="fa fa-file"></span><span>MONITORING PAKAN</span>
                </div>
                <div class="col-sm-8 col-sm-offset-2 white-bg mb">
                    ...
                    <div class="form-group">
                        <label class="control-label col-sm-4" for="tnama">Tgl Tebar:</label>
                        <div class="col-sm-6">
                            <label class=" col-sm-4" for="tnama">12 Januari 2018</label>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-sm-4" for="tnama">Jumlah Bibit</label>
                        <div class="col-sm-6">
                            <label class=" col-sm-4" for="tnama">1000</label>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-sm-4" for="tnama">Size:</label>
                        <div class="col-sm-6">
                            <label class="col-sm-4" for="tnama">4</label>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-sm-4" for="tnama">Biomass:</label>
                        <div class="col-sm-6">
                            <label class="col-sm-4" for="tnama">10</label>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-sm-4" for="tnama">Waktu Pakan:</label>
                        <div class="col-sm-6">
                        <select class="form-control">
                            <option>Pagi</option>
                        </select>
                    ...
                    <div class="form-group">
                        <label class="control-label col-sm-4" for="tnama">Jenis Pakan:</label>
                        <div class="col-sm-6">
                        <select class="form-control">
                            <option>Vit A</option>
                        </select>
                    ...
                    <div class="form-group">
                        <label class="control-label col-sm-4" for="tnama">Jumlah Pakan:</label>
                        <div class="col-sm-6">
                            <?php echo form_input(array('name'=>'tnama', 'id'=>'tnama', 'class'=>'form-control', 'placeholder'=>'Masukkan Jumlah Pakan'), $tnama);?>
                            <?php echo form_error('tnama'); ?>
                        </div>
                    </div>

                    <div class="form-group">
                        <label class="control-label col-sm-4" for="tnama">MR:</label>
                        <div class="col-sm-6">
                            <?php echo form_input(array('name'=>'tnama', 'id'=>'tnama', 'class'=>'form-control', 'placeholder'=>'Berapa Ekor yang Mati'), $tnama);?>
                            <?php echo form_error('tnama'); ?>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <?php echo form_input(array('name'=>'tnama', 'id'=>'tnama', 'class'=>'form-control', 'placeholder'=>'Masukkan Keterangan'), $tnama);?>
                            <?php echo form_error('tnama'); ?>
                        </div>
                    </div>
                    <div class="form-group">
            ...
            <div class="header-div-plain col-sm-12 mt" id="div-header">
                <span class="fa fa-table"></span><span>DATA MONITORING PAKAN</span>
            </div>
