        ...
        <section class="wrapper site-min-height">
            ...
            <div class="<?=$show_insert;?>">
                <div class="header-div-plain col-sm-8 col-sm-offset-2 mt" id="div-header">
                    <span class="fa fa-file"></span><span>MONITORING AIR</span>
                </div>
                <div class="col-sm-8 col-sm-offset-2 white-bg mb">
                    ...
                    <div class="form-group">
                        <label class="control-label col-sm-4" for="tnama">Tinggi Air:</label>
                        <div class="col-sm-6">
                            <?php echo form_input(array('name'=>'tnama', 'id'=>'tnama', 'class'=>'form-control', 'placeholder'=>'Masukkan tinggi air'), $tnama);?>
                            <?php echo form_error('tnama'); ?>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-sm-4" for="tnama">Waktu Kontrol:</label>
                        <div class="col-sm-6">
                            <select class="form-control">
                                <option>Pagi</option>
                            </select>
                    ...
                    <div class="form-group">
                        <label class="control-label col-sm-4" for="tnama">PH:</label>
                        <div class="col-sm-6">
                            <?php echo form_input(array('name'=>'tnama', 'id'=>'tnama', 'class'=>'form-control', 'placeholder'=>'Masukkan PH'), $tnama);?>
                            <?php echo form_error('tnama'); ?>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-sm-4" for="tnama">Suhu:</label>
                        <div class="col-sm-6">
                            <?php echo form_input(array('name'=>'tnama', 'id'=>'tnama', 'class'=>'form-control', 'placeholder'=>'Masukkan Suhu'), $tnama);?>
                            <?php echo form_error('tnama'); ?>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-sm-4" for="tnama">KCR:</label>
                        <div class="col-sm-6">
                            <?php echo form_input(array('name'=>'tnama', 'id'=>'tnama', 'class'=>'form-control', 'placeholder'=>'Masukkan KCR'), $tnama);?>
                            <?php echo form_error('tnama'); ?>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-sm-4" for="tnama">Warna Air:</label>
                        <div class="col-sm-6">
                            <?php echo form_input(array('name'=>'tnama', 'id'=>'tnama', 'class'=>'form-control', 'placeholder'=>'Masukkan Warna Air'), $tnama);?>
                            <?php echo form_error('tnama'); ?>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-sm-4" for="tnama">Aplikasi Bahan Penolong:</label>
                        <div class="col-sm-6">
                            <?php echo form_input(array('name'=>'tnama', 'id'=>'tnama', 'class'=>'form-control', 'placeholder'=>'Masukkan Bahan Penolong'), $tnama);?>
                            <?php echo form_error('tnama'); ?>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <?php echo form_input(array('name'=>'tnama', 'id'=>'tnama', 'class'=>'form-control', 'placeholder'=>'Keterangan'), $tnama);?>
                            <?php echo form_error('tnama'); ?>
                        </div>
                    </div>
                    <div class="form-group">
            ...
            <div class="header-div-plain col-sm-12 mt" id="div-header">
                <span class="fa fa-table"></span><span>DATA MONITORING AIR</span>
            </div>
