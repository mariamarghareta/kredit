        ...
        <section class="wrapper site-min-height">
            ...
            <div class="<?=$show_insert;?>">
                <div class="header-div-plain col-sm-8 col-sm-offset-2 mt" id="div-header">
                    <span class="fa fa-file"></span><span>GRADING</span>
                </div>
                <div class="col-sm-8 col-sm-offset-2 white-bg mb">
                    ...
                    <div class="form-group">
                        <label class="control-label col-sm-4" for="tnama">Asal Kolam:</label>
                        <div class="col-sm-6">
                            <label class="col-sm-4" for="tnama">A1</label>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-sm-4" for="tnama">Ukuran:</label>
                        <div class="col-sm-6">
                            <?php echo form_input(array('name'=>'tnama', 'id'=>'tnama', 'class'=>'form-control', 'placeholder'=>''), $tnama);?>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-sm-4" for="tnama">Dipindah ke Kolam:</label>
                        <div class="col-sm-6">
                    ...
                    <div class="form-group">
                        <label class="control-label col-sm-4" for="tnama">Berat Grading:</label>
                        <div class="col-sm-6">
                            <?php echo form_input(array('name'=>'tnama', 'id'=>'tnama', 'class'=>'form-control', 'placeholder'=>''), $tnama);?>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-sm-4" for="tnama">Jumlah Populasi:</label>
                        <div class="col-sm-6">
                            <label class="col-sm-4" for="tnama">0</label>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <label class="control-label col-sm-4" for="tnama">Up Kenaikan Daging:</label>
                        <div class="col-sm-6">
                            <label class="col-sm-4" for="tnama">0</label>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-sm-4" for="tnama">Feed Conversion Rate:</label>
                        <div class="col-sm-6">
                            <label class="col-sm-4" for="tnama">0</label>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-sm-4" for="tnama">ADG:</label>
                        <div class="col-sm-6">
                            <label class="col-sm-4" for="tnama">0</label>
                        </div>
                    </div>
            ...
            <div class="header-div-plain col-sm-12 mt" id="div-header">
                <span class="fa fa-table"></span><span>DATA GRADING</span>
            </div>
            <div class="detail-tabel col-sm-12">
                ...
                <button type='submit' class='btn btn-info center-block'>Simpan Data Grading</button>
            </div>
